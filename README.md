This repository implements the 4-layer DCGAN with Pytorch and trained with Anime-Face-Dataset from [Anime-Face-Dataset](https://github.com/bchao1/Anime-Face-Dataset).
